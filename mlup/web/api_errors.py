...
from mlup.errors import PredictError, PredictWaitResultError,QueueResultError, PredictTransformDataError, \
...
def predict_errors_handler(
    request: Request,
    exc: Union[PredictError, PredictWaitResultError, QueueResultError,PredictTransformDataError, PredictValidationInnerDataError],
):
    headers = {}
